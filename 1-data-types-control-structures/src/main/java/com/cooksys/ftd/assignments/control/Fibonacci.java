...
public class Fibonacci {
    ...
    public static int atIndex(int i) throws IllegalArgumentException {
    	if (i < 0) throw new IllegalArgumentException("Index is less than zero");
    	
    	if (i == 0 || i == 1) return 1;
    	
    	int[] fibArray = fibonacci(i + 1);
    	return fibArray[i];
    }
