...
public class SimplifiedRational implements IRational {
    ...
    public static int gcd(int a, int b) throws IllegalArgumentException {
    	if ((a <= 0) || (b < 0)) throw new IllegalArgumentException("a <= 0 or b < 0");
    ...
    public static int[] simplify(int numerator, int denominator) throws IllegalArgumentException {
    	...
    	simpResult[0] = numerator / gcd;
    	simpResult[1] = denominator / gcd;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SimplifiedRational) { 
        	if (this.numerator == ((SimplifiedRational)obj).numerator && this.denominator == ((SimplifiedRational)obj).denominator) {
        		return true;
        	}
        	else return false;
        }
    ...
    public String toString() {
    	String simpString = null;
        
        if (this.getNumerator() < 0 != this.getDenominator() < 0)
        	simpString = "-" + Math.abs(this.getNumerator()) + "/" + Math.abs(this.getDenominator());
        else
        	simpString = Math.abs(this.getNumerator()) + "/" + Math.abs(this.getDenominator());
